...
csv_file = 'tensor_times_sum.csv'
check_list = [3, 4, 5, 6, 7, 8, 9]
...
with open(csv_file, mode='w', newline='') as file:
    ...
    for n in check_list:
        ...
        sum_tt, summation_time = tt_sum(tensor_train, tensor_train2)
        writer.writerow([n, summation_time])
        print(f"n={n}, summation_time={summation_time}")
